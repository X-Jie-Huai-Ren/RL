...
class TrainManager:
    ...
    def __init__(self, env, episodes=1000, lr=0.001, gamma=0.9, eps_greedy=0.1, eps_greedy_decay=1e-6, memory_size=2000, 
        ...
        explorer = Explorer(n_act=num_act, eps_greedy=eps_greedy, decay_rate=eps_greedy_decay)
        self.agent = DQNAgent(
            q_func=q_func,
            replay_buffer=rb,
